...
const modelEnhancements = {
    "gpt-6-astra": { modalities: ["text", "image", "audio", "video"], outModes: ["text", "image", "audio"], openSource: false, cutoff: "Aug 2026", maxOut: "32k", latency: "~2.0s" },
    ...
    "claude-fable-5-1": { modalities: ["text", "image", "pdf"], outModes: ["text"], openSource: false, cutoff: "Jul 2026", maxOut: "128k", latency: "~1.8s" },
    "claude-opus-5": { modalities: ["text", "image", "pdf"], outModes: ["text"], openSource: false, cutoff: "May 2026", maxOut: "128k", latency: "~1.5s" },
    ...
    "gemini-3-8-flash": { modalities: ["text", "image", "audio", "video"], outModes: ["text", "audio"], openSource: false, cutoff: "Aug 2026", maxOut: "65k", latency: "~0.4s" },
    ...
    "deepseek-v4-1-flash": { modalities: ["text", "image"], outModes: ["text"], openSource: true, cutoff: "Aug 2026", maxOut: "8k", latency: "~0.5s" },
    ...
    "grok-4-6": { modalities: ["text", "image"], outModes: ["text"], openSource: false, cutoff: "Aug 2026", maxOut: "8k", latency: "~0.9s" },
